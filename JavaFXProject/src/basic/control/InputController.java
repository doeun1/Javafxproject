...
//		comboPublic.setValue("public");
	...
	public void showPopup(String msg) {
		//popup 타이틀 등록.
		HBox hbox = new HBox();
		hbox.setStyle("-fx-background-color: black; -fx-background-radius: 20;");//백그라운드 색바꿈
		...
		label.setText(msg);
		label.setStyle("-fx-text-fill : yellow; ");//글자색바꿈
